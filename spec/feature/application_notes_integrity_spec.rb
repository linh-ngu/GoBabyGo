...
RSpec.describe 'NO ACCOUNT: Attempt to access application note pages', type: :feature do
    ...
    before do
        @user_application = UserApplication.create(id: 1, user_id: 1, child_first_name: "test", child_last_name: "child", child_birthdate: "2022-12-12", primary_diagnosis: "Can't walk", secondary_diagnosis: "N/A", child_height: 20, child_weight: 10, caregiver_email:"test@gmail.com", caregiver_first_name:"test", caregiver_last_name:"child", caregiver_phone:"1234567890", can_transport:true, can_store:true)
...
RSpec.describe 'VISITOR: Attempt to access application note pages that do not belong to the user.', type: :feature do
    ...
    before do
        ...
        sign_in @admin
        @user1 = User.create!(id: 1, first_name: "test", last_name: "name", email: 'test1@gmail.com', phone: '1234567890', admin_id: @admin.id, level: :visitor)
        @user_application = UserApplication.create(id: 2, user_id: 2, child_first_name: "test", child_last_name: "child", child_birthdate: "2022-12-12", primary_diagnosis: "Can't walk", secondary_diagnosis: "N/A", child_height: 20, child_weight: 10, caregiver_email:"test@gmail.com", caregiver_first_name:"test", caregiver_last_name:"child", caregiver_phone:"1234567890", can_transport:true, can_store:true)
...
RSpec.describe 'APPLICANT: Attempt to access application note pages that do not belong to the user.', type: :feature do
    ...
    before do
        ...
        sign_in @admin
        @user1 = User.create!(id: 1, first_name: "test", last_name: "name", email: 'test1@gmail.com', phone: '1234567890', admin_id: @admin.id, level: :applicant)
        @user_application = UserApplication.create(id: 2, user_id: 2, child_first_name: "test", child_last_name: "child", child_birthdate: "2022-12-12", primary_diagnosis: "Can't walk", secondary_diagnosis: "N/A", child_height: 20, child_weight: 10, caregiver_email:"test@gmail.com", caregiver_first_name:"test", caregiver_last_name:"child", caregiver_phone:"1234567890", can_transport:true, can_store:true)
        @application_note = ApplicationNote.create(id: 3, user_application_id: @user_application.id, content: "This is a test note.")
    end
